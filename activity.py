...
def find_common_songs():
    ...
    # YOUR CODE HERE:
    common = set.intersection(friend_songs & my_playlist)  # Replace this with the intersection!
    ...
    if common:
        ...
        # YOUR CODE HERE:
        display_songs(common, "Songs you have been shared with {friend}")
...
def find_unique_songs():
    ...
    # YOUR CODE HERE:
    only_mine = set.difference(my_playlist - friend_songs)  # Replace this!

    # TODO: Find songs in FRIEND's playlist but NOT in yours
    # Store in 'only_theirs'

    # YOUR CODE HERE:
    only_theirs = set.difference(friend_songs - my_playlist)  # Replace this!
...
def get_recommendations():
    ...
    # YOUR CODE HERE:
    all_friend_songs = set(friends_playlists.values())
...
def combine_playlists():
    ...
    # YOUR CODE HERE:
    combined = set.union(my_playlist, friend_songs)  # Replace this!
...
def view_stats():
    ...
    # YOUR CODE HERE:
    set.issubset(favorites <= my_playlist)
